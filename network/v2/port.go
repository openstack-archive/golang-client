...
func (networkService Service) Ports() ([]PortResponse, error) {
	...
	var p = portsResp{}
	err := misc.GetJSON(reqURL, networkService.TokenID, networkService.Client, &p)
	if err != nil {
		return nil, err
	}
...
func (networkService Service) Port(id string) (PortResponse, error) {
	...
	port := portResp{}
	err := misc.GetJSON(reqURL, networkService.TokenID, networkService.Client, &port)
...
func (networkService Service) CreatePort(parameters CreatePortParameters) (PortResponse, error) {
	...
	err := misc.PostJSON(reqURL, networkService.TokenID, networkService.Client, parametersContainer, &portResponse)
