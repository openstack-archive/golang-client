...
type ImageDetailResponse struct {
	CheckSum        string            `json:"checksum"`
	ContainerFormat string            `json:"container_format"`
	CreatedAt       string            `json:"created_at"` // Should be a DateTime
	Deleted         bool              `json:"deleted"`
	DeletedAt       *string           `json:"deleted_at"` // Should be a DateTime
	DiskFormat      string            `json:"disk_format"`
	Id              string            `json:"id"`
	...
	UpdatedAt       string            `json:"updated_at"` // Should be a DateTime
