...
func TestMarkerLimitUrlProduced(t *testing.T) {
	testImageQueryParameter(t, "images?limit=20&marker=bec3cab5-4722-40b9-a78a-3489218e22fe",
		image.ImageQueryParameters{Marker: "bec3cab5-4722-40b9-a78a-3489218e22fe", Limit: 20})
}

func TestContainerFormatFilterUrlProduced(t *testing.T) {
	testImageQueryParameter(t, "images?container_format=bare",
		image.ImageQueryParameters{ContainerFormat: "bare"})
}

func TestSortKeySortUrlProduced(t *testing.T) {
	testImageQueryParameter(t, "images?sort_key=id",
		image.ImageQueryParameters{SortKey: "id"})
}

func TestSortDirSortUrlProduced(t *testing.T) {
	testImageQueryParameter(t, "images?sort_dir=asc",
		image.ImageQueryParameters{SortDirection: image.Asc})
}

func testImageQueryParameter(t *testing.T, uriEndsWith string, queryParameters image.ImageQueryParameters) {
	anon := func(imageService *image.ImageService) {
...
func testImageServiceAction(t *testing.T, uriEndsWith string, testData string, imageServiceAction func(*image.ImageService)) {
	...
	imageService := image.ImageService{TokenId: tokn, Client: *http.DefaultClient, Url: apiServer.URL}
